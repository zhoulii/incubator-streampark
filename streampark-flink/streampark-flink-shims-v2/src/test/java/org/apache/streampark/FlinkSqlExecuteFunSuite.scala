...
import org.apache.streampark.flink.shims.base.{FlinkSqlExecutor, FlinkTableInitializer}
...
class FlinkSqlExecuteFunSuite extends AnyFunSuite {
  ...
  def execute(sql: String)(implicit func: String => Unit): Unit = {
    ...
    val value = FlinkTableInitializer.initialize(args.toArray, null, null)
    val context = FlinkShimLoader.loadStreamTableContext(value._1, value._2, value._3)
