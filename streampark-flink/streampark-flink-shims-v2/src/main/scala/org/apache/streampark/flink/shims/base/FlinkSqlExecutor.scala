 ...
 */
package org.apache.streampark.flink.shims.base

import org.apache.flink.api.java.utils.ParameterTool
import org.apache.flink.configuration.Configuration
import org.apache.streampark.common.conf.ConfigConst.KEY_FLINK_SQL
import org.apache.streampark.common.util.Logger
import org.apache.streampark.flink.shims.base.SqlCommand._
import org.apache.streampark.flink.shims.context.TableContextTrait
...
object FlinkSqlExecutor extends Logger {
  ...
  private[streampark] def executeSql(sql: String, parameter: ParameterTool, context: TableContextTrait)(implicit callbackFunc: String => Unit = null): Unit = {
