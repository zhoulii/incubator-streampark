...
public class FlinkJobID implements Comparable<FlinkJobID>, java.io.Serializable {
     ...
     */
    public FlinkJobID(long lowerPart, long upperPart) {
     ...
     */
    public FlinkJobID(FlinkJobID id) {
        if (id == null) {
    ...
    public final String toHexString() {
        if (this.hexString == null) {
            ...
            this.hexString = byteToHexString(ba);
        }
    ...
    public static String byteToHexString(final byte[] bytes) {
        return StringUtil.byteToHexString(bytes, 0, bytes.length);
    }
    ...
    public boolean equals(Object obj) {
        if (obj == this) {
            ...
            FlinkJobID that = (FlinkJobID) obj;
    ...
    @Override
    public int compareTo(FlinkJobID o) {
